...
export default function RegisterPage() {
  ...
  const handleRegister = async (e) => {
    ...
    await signUp.email({
      ...
      // role: formData.role,
      callbackURL: formData.role === 'hr' ? '/dashboard/hr' : '/dashboard/employee',
    }, {
      onSuccess: () => {
        toast.success("Account created successfully!", { id: toastId });
        router.push(formData.role === 'hr' ? '/dashboard/hr' : '/dashboard/employee');
      },
      onError: (ctx) => {
        ...
        <Card className="p-6 md:p-8 bg-white border border-slate-200 shadow-xl rounded-2xl">
          ...
          <form onSubmit={handleRegister} className="space-y-4 pt-5">
            ...
            <div className="grid md:grid-cols-2 gap-4">
              ...
              {/* Employee ID */}
              <TextField fullWidth name="empId">
