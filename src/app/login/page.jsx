  ...
  <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4">
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-500 text-sm mt-2">Employee Attendance Management Portal</p>
      </div>
        ...
        <div className="pt-4">
          ...
          >
            <Tabs.ListContainer className="w-full bg-slate-100 p-1 rounded-xl">
              <Tabs.List aria-label="Role Selection" className="w-full grid grid-cols-2 text-center text-sm font-medium">
                <Tabs.Tab
                  id="employee"
            ...
            <form onSubmit={handleLogin} className="space-y-4 pt-5">
              ...
              <Card.Footer className="px-0 pt-3">
                ...
                >
                  ...
                  Login as {selectedRole === 'employee' ? 'Employee' : 'HR Admin'}
                </Button>
              </Card.Footer>
